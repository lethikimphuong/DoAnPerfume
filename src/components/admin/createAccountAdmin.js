...
function CreateAccountAdmin(props) {
    ...
    <section className="section-main-content">
      <div className="container">
        <div className="section-wrap">
          <h3 className="section-title">Register new admin</h3>
          <form className="form form-register">
            ...
            <div className="row form-item form-btn">
              ...
              <button className="btn btn-reset-new-product">Reset</button>
            </div>
          </form>
        </div>
      </div>
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    onCreateAccount: (account) => {
      dispatch(actions.createAccountAdmin(account));
    }
  }
}
export default connect(mapStateToProps, mapDispatchToProps)(CreateAccountAdmin);
